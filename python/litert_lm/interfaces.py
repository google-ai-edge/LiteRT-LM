...
class AbstractEngine(abc.ABC):
  ...
  Attributes:
      ...
      vision_tokens_per_image: Maximum number of vision tokens per image. When
        ...
        fit this budget, and conversations created by the engine downscale each
        input image to fit it. Image downscaling is currently only supported by
        Gemma4 models, whose budget options are 70, 140, 280, 560, or 1120. If
