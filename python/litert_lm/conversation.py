...
class Conversation(interfaces.AbstractConversation):
  ...
  def _create_optional_args(
    ...
    if max_output_tokens is None and enable_thinking is None:
      return None
    ...
    if enable_thinking is not None:
      self._lib.litert_lm_conversation_optional_args_set_enable_thinking(
          ptr, enable_thinking
      )
    return ptr
  ...
  def send_message(
    ...
    while True:
      ...
      optional_args_ptr = self._create_optional_args(
          max_output_tokens, enable_thinking
      )
      try:
