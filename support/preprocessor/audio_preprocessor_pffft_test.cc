...
TEST(AudioPreprocessorPffftTest, DecodeAudio) {
  ...
  ASSERT_OK_AND_ASSIGN(
      auto pcm_frames,
      AudioPreprocessorPffft::DecodeAudio(raw_audio_data, /*num_channels=*/1,
                                          /*sample_rate_hz=*/16000));
...
TEST(AudioPreprocessorPffftTest, DecodeAudioStereo16BitPcm) {
  ...
  ASSERT_OK_AND_ASSIGN(
      auto pcm_frames,
      AudioPreprocessorPffft::DecodeAudio(wav, /*num_channels=*/1,
                                          /*sample_rate_hz=*/16000));
...
TEST(AudioPreprocessorPffftTest, DecodeAudioValidationErrors) {
  ...
  // Invalid RIFF header.
  EXPECT_THAT(AudioPreprocessorPffft::DecodeAudio(
                  "NOT_RIFF_123456", /*num_channels=*/1, 16000),
              testing::status::StatusIs(
                  absl::StatusCode::kInvalidArgument,
  ...
  // Invalid WAVE header.
  EXPECT_THAT(AudioPreprocessorPffft::DecodeAudio(
                  "RIFF1234NOTW", /*num_channels=*/1, 16000),
              testing::status::StatusIs(
                  absl::StatusCode::kInvalidArgument,
                  testing::HasSubstr("not a valid RIFF/WAVE file")));
  ...
  EXPECT_THAT(AudioPreprocessorPffft::DecodeAudio(
                  corrupted_chunk, /*num_channels=*/1, 16000),
              testing::status::StatusIs(
                  absl::StatusCode::kInvalidArgument,
  ...
  EXPECT_THAT(AudioPreprocessorPffft::DecodeAudio(
                  small_fmt_wav, /*num_channels=*/1, 16000),
              testing::status::StatusIs(
                  absl::StatusCode::kInvalidArgument,
  ...
  EXPECT_THAT(AudioPreprocessorPffft::DecodeAudio(
                  missing_data_wav, /*num_channels=*/1, 16000),
              testing::status::StatusIs(
                  absl::StatusCode::kInvalidArgument,
