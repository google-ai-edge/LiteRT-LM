...
set(LITERTLM_PROTOBUF_EXT_PREFIX
  "${LITERTLM_EXTERNAL_PROJECT_BIN_DIR}/protobuf"
  CACHE PATH "")
set(LITERTLM_PROTOBUF_INSTALL_PREFIX
  "${LITERTLM_PROTOBUF_EXT_PREFIX}/install"
  CACHE PATH "")
set(LITERTLM_PROTOBUF_CONFIG_PATH
  "${LITERTLM_PROTOBUF_PACKAGE_DIR}/protobuf_config.cmake"
  CACHE PATH "")
set(LITERTLM_PROTOBUF_SRC_DIR
  "${LITERTLM_PROTOBUF_EXT_PREFIX}/src/protobuf_external"
  CACHE PATH "")
set(LITERTLM_PROTOBUF_BUILD_DIR
  "${LITERTLM_PROTOBUF_EXT_PREFIX}/src/protobuf_external-build"
  CACHE PATH "")
set(LITERTLM_PROTOBUF_STAMP_DIR
  "${LITERTLM_PROTOBUF_EXT_PREFIX}/src/protobuf_external-stamp"
  CACHE INTERNAL "")
set(LITERTLM_PROTOBUF_INCLUDE_DIR
  "${LITERTLM_PROTOBUF_INSTALL_PREFIX}/include"
  "${LITERTLM_PROTOBUF_INSTALL_PREFIX}"
  CACHE PATH "")
set(LITERTLM_PROTOBUF_LIB_DIR
  "${LITERTLM_PROTOBUF_INSTALL_PREFIX}/lib"
  CACHE PATH "")
set(LITERTLM_PROTOBUF_LITE_LIBRARY
  "${LITERTLM_PROTOBUF_INSTALL_PREFIX}/lib/libprotobuf-lite.a"
  CACHE PATH "")
...
if("${LITERTLM_ORCHESTRATION_PHASE}" STREQUAL "litert_lm" OR DEFINED LITERTLM_HOST_PROTOC)
    ...
    set(LITERTLM_PROTOC_EXE "${LITERTLM_HOST_PROTOC}" CACHE PATH "Host protoc" FORCE)
