...
set(LITERTLM_TFLITE_TARGET_MAP_PATH 
  "${LITERTLM_TFLITE_PACKAGE_DIR}/tflite_${LITERTLM_ORCHESTRATION_PHASE}_target_map.cmake" 
  CACHE PATH "")

set(LITERTLM_TFLITE_EIGEN_DIR "${LITERTLM_TFLITE_BUILD_DIR}/eigen" CACHE PATH "")
set(LITERTLM_TENSORFLOW_PYBIND11_DIR "${LITERTLM_TENSORFLOW_SRC_DIR}/tensorflow/python/lib/core" CACHE PATH "")