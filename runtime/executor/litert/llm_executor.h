...
class LlmExecutorCommonCore {
 public:
  ...
  // The path to the weight cache directory. Executor will take the ownership
  // of this path to maintain the path lifecycle.
  ...
  // The LoRA manager for loading and managing LoRA weights.
  int next_lora_id_ = 0;
