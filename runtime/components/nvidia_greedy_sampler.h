...
// NVIDIA float buffers are errors; other backends/types/configs are unsupported.
...
// Requires LITERT_NVIDIA_MTP_GPU_SAMPLING=1; never loads a new dispatch instance.
